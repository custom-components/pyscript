...
""",
    ...
    assert (
        "func4 defined in file.hello: needs at least one trigger decorator (ie: event_trigger, mqtt_trigger, state_trigger, time_trigger, webhook_handler, webhook_trigger)"
        in caplog.text
    )
