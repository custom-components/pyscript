...
This is 2.1.0, released on August 11, 2026.  Here is the `documentation
<https://hacs-pyscript.readthedocs.io/en/2.1.0>`__ for that release.  Here is the
...
If you want to see development progress since 2.1.0, look at the
